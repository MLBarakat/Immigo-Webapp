...
function ListeningAnimation() {
  return (
    <div className="w-full h-full flex justify-center items-center gap-1.5 text-green-400">
...
function ProcessingAnimation() {
    return (
        <div className="w-full h-full flex items-center justify-center text-indigo-300 intro-hourglass">
...
function SpeakingAnimation() {
    return (
        <div className="w-full h-full flex items-center justify-center">
            <svg viewBox="0 0 100 100" className="w-full h-full text-teal-300 orb intro-orb">
                <defs>
...
const STATUS_MAP: Record<AppStatus, { component: JSX.Element; color: string }> = {
  idle: { component: <IdleAnimation />, color: 'border-sky-500/30' },
  listening: { component: <ListeningAnimation />, color: 'border-green-500/30' },
  processing: { component: <ProcessingAnimation />, color: 'border-indigo-500/30' },
  speaking: { component: <SpeakingAnimation />, color: 'border-teal-500/30' },
  error: { component: <ErrorAnimation />, color: 'border-red-500/30' },
};
