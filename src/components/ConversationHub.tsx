  ...
  return (
      <div className="flex flex-col justify-between w-full h-full bg-star-white rounded-lg shadow-md p-6">
          <div className="flex flex-col space-y-2">
              ...
              <button onClick={onDownloadTranscript} className="flex items-center justify-center p-3 rounded-lg bg-immigo-gray-100 hover:bg-immigo-gray-200 text-sm font-medium text-immigo-gray-700 disabled:opacity-50 disabled:cursor-not-allowed">
                  <Download className="w-4 h-4 mr-2" /> Download Script
              </button>
              <button onClick={onClearConversation} className="flex items-center justify-center p-3 rounded-lg bg-immigo-gray-100 hover:bg-immigo-gray-200 text-sm font-medium text-art-red-600 disabled:opacity-50 disabled:cursor-not-allowed">
